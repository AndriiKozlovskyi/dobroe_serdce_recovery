        ...
        <div className="detox-grid">
          <div className="detox-visual reveal-l">
            <div className="detox-vis-main">
              <div className="detox-vis-inner" style={{ justifyContent: 'flex-start', gap: '1.25rem', padding: '2.5rem' }}>
                ...
                <div>
                  ...
                  <div style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.4rem', fontWeight: 700, color: '#fff', lineHeight: 1.15 }}>
                    Программа<br />
                    <span style={{ fontSize: '.95rem', fontWeight: 400, color: 'rgba(255,255,255,.45)' }}>под медицинским контролем</span>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '.55rem' }}>
                  {[
                    ...
                    { label: 'Детоксикация', pct: 78, color: 'var(--brand-500)' },
                    { label: 'Стабилизация', pct: 52, color: 'var(--sap-400)' },
                    { label: 'Реабилитация', pct: 28, color: 'rgba(255,255,255,.3)' },
                  ].map(({ label, pct, color }) => (
                    <div key={label}>
                  ...
                  {[
                    ...
                    <div key={lbl} style={{ background: 'rgba(255,255,255,.05)', border: '1px solid rgba(249,189,21,.1)', borderRadius: '.85rem', padding: '.75rem' }}>
                      ...
                      <div style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.1rem', fontWeight: 700, color: 'var(--brand-400)', lineHeight: 1 }}>
                        {val}<span style={{ fontSize: '.65rem', color: 'rgba(255,255,255,.3)', marginLeft: '2px' }}>{unit}</span>
                      </div>
                      <div style={{ fontSize: '.58rem', color: 'rgba(255,255,255,.32)', marginTop: '3px', letterSpacing: '.06em', textTransform: 'uppercase' }}>{lbl}</div>
                    </div>
                  ))}
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '.6rem' }}>
                  ...
                  <span style={{ fontSize: '.68rem', color: 'rgba(255,255,255,.38)', fontWeight: 300 }}>Пациент под наблюдением · Сейчас</span>
                </div>
