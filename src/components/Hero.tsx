...
const PARTICLES = [
  { left: '8%',  top: '20%', width: '3px', height: '3px', background: 'var(--brand-500)', animation: 'float 8s ease-in-out infinite' },
  { left: '22%', top: '65%', width: '2px', height: '2px', background: 'rgba(255,255,255,.5)', animation: 'drift 10s ease-in-out infinite 1s' },
  { left: '35%', top: '30%', width: '4px', height: '4px', background: 'var(--brand-400)', opacity: .5, animation: 'float 9s ease-in-out infinite 2s' },
  { left: '60%', top: '75%', width: '2px', height: '2px', background: 'rgba(255,255,255,.4)', animation: 'drift 7s ease-in-out infinite .5s' },
  { left: '78%', top: '18%', width: '3px', height: '3px', background: 'var(--brand-300)', animation: 'float 11s ease-in-out infinite 1.5s' },
  { left: '88%', top: '55%', width: '2px', height: '2px', background: 'rgba(255,255,255,.3)', animation: 'drift 8s ease-in-out infinite 3s' },
];

const CROSSES = [
  { top: '22%', right: '24%', size: 18, opacity: .18, color: 'var(--brand-500)', animation: 'float 9s ease-in-out infinite 1s' },
  ...
  return (
    <section id="hero">
      ...
      {CROSSES.map((c, i) => (
        ...
        >
          <div style={{ position: 'absolute', top: '50%', left: 0, width: '100%', height: '1.5px', background: c.color, transform: 'translateY(-50%)' }}></div>
          <div style={{ position: 'absolute', left: '50%', top: 0, width: '1.5px', height: '100%', background: c.color, transform: 'translateX(-50%)' }}></div>
        </div>
      ))}
        ...
        <div className="hero-grid">
          ...
          <div>
            ...
            <div className="hero-trust">
              ...
              <div className="hero-trust-item"><span className="ico">🏥</span>Лицензированная клиника</div>
            </div>
          </div>
