      ...
      <div className="container">
        <div className="testi-grid">
          <div>
            ...
            >
              Каждая история — это победа над зависимостью. Наши пациенты возвращаются к
              ...
              >
                ...
                <div className="testi-author">
                  ...
                  <div>
                    ...
                    <div className="testi-author-meta">{t.city} · {t.age}</div>
                  </div>
                </div>
              </div>
            ))}
