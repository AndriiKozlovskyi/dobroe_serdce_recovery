				...
				<div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", alignItems: "start" }}>
					<div>
						...
						<div className="social-pills reveal d-3" style={{ display: "flex", gap: "1rem" }}>
							<a href="https://t.me/+380671915373" className="social-pill" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "rgba(109,169,214,.12)", border: "1px solid rgba(109,169,214,.3)", color: "#6DA9D6" }}>
							...
							<a href="https://instagram.com/" className="social-pill" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "rgba(225,48,108,.12)", border: "1px solid rgba(225,48,108,.3)", color: "#E1306C" }}>
