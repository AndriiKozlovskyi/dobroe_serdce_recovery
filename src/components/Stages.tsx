      ...
      <section id="stages" className="section">
        <div className="container" style={{position:'relative'}}>
          <div className="section-head">
            ...
            <h2 className="section-title on-dark reveal d-1">Этапы лечения зависимостей</h2>
            <p className="section-sub on-dark reveal d-2">
              Каждый этап выстроен так, чтобы обеспечить максимально мягкое и эффективное
              выздоровление
            </p>
          </div>
          <div className="stages-grid" style={{position:'relative'}}>
            ...
            <div className="stage-card reveal d-1">
              ...
              <p className="stage-desc">
                Очищение организма от вредных веществ под контролем специалистов с медикаментозной
                поддержкой для снятия симптомов отмены
              </p>
            ...
            <div className="stage-card reveal d-2">
              ...
              <p className="stage-desc">
                Комплексный подход с индивидуальными и групповыми терапевтическими сессиями. Работа
                с психологами и наркологами
              </p>
            ...
            <div className="stage-card reveal d-3">
              ...
              <p className="stage-desc">
                Развитие жизненных навыков, построение здоровых отношений и подготовка к
                самостоятельной трезвой жизни
              </p>
            ...
            <div className="stage-card reveal d-4">
              ...
              <p className="stage-desc">
                Регулярные встречи с терапевтом, группы поддержки и программы для предотвращения
                рецидива на долгосрочной основе
              </p>
